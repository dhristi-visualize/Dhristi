...
var xt = /\b(?:position|zIndex|opacity|transform|webkitTransform|mixBlendMode|filter|webkitFilter|isolation)\b/;
function zt(e) {
...
function Ye({
  ...
  n.forEach((c) => {
    ...
    const g = o.get(m), {
      ...
      layout: S,
      separatorToPanels: w
    } = i.get(m) ?? { defaultLayoutDeferred: false };
    if (x && g && S && w) {
      const C = te({
        delta: p,
        initialLayout: g,
...
function Gt(e) {
  ...
  }), W.get(h) === 1 && (h.addEventListener("dblclick", we, true), h.addEventListener("pointerdown", Ce, true), h.addEventListener("pointerleave", ke), h.addEventListener("pointermove", Ge), h.addEventListener("pointerout", Ie), h.addEventListener("pointerup", De, true)), function() {
    t = false, W.set(
      h,
      ...
      Ce,
      true
    ), h.removeEventListener("pointerleave", ke), h.removeEventListener("pointermove", Ge), h.removeEventListener("pointerout", Ie), h.removeEventListener("pointerup", De, true)), r.disconnect();
  };
}
function Ze() {
...
function Dt(e, t) {
  ...
  (0, import_react.useImperativeHandle)(t, () => n.current, []), j(() => {
    Object.assign(
      n.current,
      Ue({ groupId: e })
    );
...
function Tt({
  ...
  const f = (0, import_react.useRef)({
    onLayoutChange: {},
    onLayoutChanged: {}
  }), d = J((b) => {
    $(f.current.onLayoutChange, b) || (f.current.onLayoutChange = b, a == null ? void 0 : a(b));
  }), p = J((b) => {
    $(f.current.onLayoutChanged, b) || (f.current.onLayoutChanged = b, u == null ? void 0 : u(b));
  }), g = me(s), v = (0, import_react.useRef)(null), [x, S] = Ze(), w = (0, import_react.useRef)({
  ...
  }), (0, import_jsx_runtime.jsx)(Je.Provider, { value: T, children: (0, import_jsx_runtime.jsx)(
    "div",
    {
      ...h,
      className: t,
...
function Vt({
  ...
  const i = t !== void 0, r = "id" in o ? o.id : o.groupId, l = fe(r, t ?? []), s = (0, import_react.useSyncExternalStore)(
    Ot,
    () => n.getItem(l),
    () => n.getItem(l)
    ...
    [s]
  ), u = (0, import_react.useRef)(null), c = (0, import_react.useCallback)(() => {
    const h = u.current;
...
function At(e, t) {
  const { id: n } = ye(), o = (0, import_react.useRef)({
    collapse: ce,
    expand: ce,
    getSize: () => ({
      asPercentage: 0,
  ...
  (0, import_react.useImperativeHandle)(t, () => o.current, []), j(() => {
    Object.assign(
      o.current,
...
function _t({
  ...
  const h = !!l, f = me(l), d = (0, import_react.useRef)(null), p = ge(d, r), [, g] = Ze(), { getPanelStyles: v, id: x, registerPanel: S } = ye(), w = u !== null, C = J(
    (T, V, A) => {
      u == null ? void 0 : u(T, l, A);
    }
  );
  j(() => {
    const T = d.current;
...
function $t({
  ...
  const l = me(o), [s, a] = (0, import_react.useState)({}), [u, c] = (0, import_react.useState)("inactive"), m = (0, import_react.useRef)(null), y = ge(m, n), {
    id: h,
    orientation: f,
    registerSeparator: d
